#!/bin/bash
#
# project-juggler - CLI tool for managing IntelliJ IDEA instances per project
#
...
JAVA_OPTS="${PROJECT_JUGGLER_OPTS:-}"

# Execute
exec "$JAVA_CMD" $JAVA_OPTS -cp "$CLASSPATH" com.projectjuggler.MainKt "$@"
